  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold font-heading transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        cta: "bg-gradient-cta text-cta-foreground shadow-cta hover:shadow-xl hover:scale-105 active:scale-100",
        hero: "bg-cta text-cta-foreground shadow-cta hover:shadow-xl hover:scale-105 border-0",
        heroOutline: "border-2 border-white/30 bg-white/10 text-white backdrop-blur-sm hover:bg-white/20 hover:border-white/50",
        steel: "bg-steel-light text-steel-dark border border-steel hover:bg-steel/20",
      },
      size: {
